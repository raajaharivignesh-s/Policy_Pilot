...
// SVG icon helpers — accept className for hover color control
const SvgLeaf = ({ className = '' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19 2c1 2 2 4.18 2 8 0 5.5-4.78 10-10 10Z"/>
    <path d="M2 21c0-3 1.85-5.36 5.08-6C9.5 14.52 12 13 13 12"/>
  </svg>
);
const SvgGraduate = ({ className = '' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M22 10v6M2 10l10-5 10 5-10 5z"/>
    <path d="M6 12v5c3 3 9 3 12 0v-5"/>
  </svg>
);
const SvgHeart = ({ className = '' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
const DOMAIN_PILLS = [
  { key: 'agri',   label: 'Agriculture', Icon: SvgLeaf,
    ...
    pillHover: 'hover:border-green-500 hover:text-green-700',
    iconHover: 'group-hover:fill-green-500 group-hover:stroke-green-600 transition-all duration-200' },
  { key: 'edu',    label: 'Education',   Icon: SvgGraduate,
    query: 'What government schemes are available for students?',
    pillHover: 'hover:border-gray-800 hover:text-gray-900',
    iconHover: 'group-hover:fill-gray-900 group-hover:stroke-gray-900 transition-all duration-200' },
  { key: 'health', label: 'Healthcare',  Icon: SvgHeart,
    query: 'What government schemes provide financial assistance for healthcare?',
    pillHover: 'hover:border-red-500 hover:text-red-600',
    iconHover: 'group-hover:fill-red-500 group-hover:stroke-red-500 transition-all duration-200' },
];
        ...
        <div className="flex flex-wrap justify-center gap-3">
          {DOMAIN_PILLS.map(d => (
            <button
              ...
              className={`group inline-flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-medium border bg-white border-gray-300 text-gray-700 transition-all duration-200 cursor-pointer ${d.pillHover}`}
            >
              <d.Icon className={d.iconHover} /> {d.label}
            </button>
          ))}
        </div>
